...
import com.meihuayishu.vone.UI.Frg.GuaciFragment;
...
public class GuaActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ConstraintLayout mPageResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        guaBean = (GuaBean) intent.getParcelableExtra("gua");
        ...
        switch (from) {
            case 1:
                bgColor = getResources().getColor(R.color.colorIndigo);
                break;
            case 2:
        ...
        mPageResult.setBackgroundColor(bgColor);
        ...
        float_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new ShareThePageImp().shareScrollViewToAllPlatform(GuaActivity.this, scr, finalBgColor,"灵犀突至偶得一卦");
            }
        });
    }
...
//        Log.i("MSL", "showResult____" + "select * from chang where UPEARLYNUM ='" + shang + "' and DOWNEARLYNUM='" + xia + "'");
    ...
    private void initView() {
        ...
        mPageResult = (ConstraintLayout) findViewById(R.id.page_result);
