...
public class BaziActivity extends BaseActivity implements View.OnClickListener {
    ...
    private static final String TAG = "MSL BaziActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);//透明工具栏r
...
//            Log.e("MSL", "showLiuNian: " + str[0]);
    ...
    private void initView() {
        ...
        mLlYearShenshea = (LinearLayout) findViewById(R.id.ll_year_shensha);
        mLlMonthShenshea = (LinearLayout) findViewById(R.id.ll_month_shensha);
        mLlDayShenshea = (LinearLayout) findViewById(R.id.ll_day_shenshea);
        mLlHourShenshea = (LinearLayout) findViewById(R.id.ll_hour_shensha);
        ...
        FloatingActionButton float_share = (FloatingActionButton) findViewById(R.id.float_share);
        float_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new ShareThePageImp().shareScrollViewToAllPlatform(BaziActivity.this, scrollView,getResources().getColor(R.color.colorRed),"机会！我的八字现在有得一瞥");
            }
        });
    }
