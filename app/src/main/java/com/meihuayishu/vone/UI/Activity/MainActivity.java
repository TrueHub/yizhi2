...
import com.meihuayishu.vone.VIEW.drawables.CircleImgDrawable;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView btn_yao;
    private ImageView btn_num;
    private ImageView btn_bazi;
    ...
    private void initView() {
        ...
        btn_yao =  (ImageView) findViewById(R.id.btn_yao);
        btn_num =  (ImageView) findViewById(R.id.btn_num);
        btn_bazi = (ImageView) findViewById(R.id.btn_bazi);
