...
//        bitmap = drawBg4Bitmap(Color.parseColor("#e0edd1b0"),bitmap);
    ...
    public static Bitmap getBitmapByView(final ScrollView scrollView , int bgColor) {
        int h = 0;
        Bitmap bitmap = null;
        Paint paint = new Paint();
...
//            Log.i("MSL", "savePic: OK " + strFileName);
    ...
    // 程序入口2 截取当前屏幕
    public static void shootScrollView(ScrollView s, int bgColor, String picpath) {
        ScreenShot.savePic(getBitmapByView(s , bgColor), picpath);
    }
